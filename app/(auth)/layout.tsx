export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative min-h-[calc(100vh-72px)] overflow-hidden bg-white text-slate-900 dark:bg-slate-950 dark:text-white">
      ...
      <div className="relative mx-auto flex min-h-full max-w-xl items-center justify-center px-4 py-8 sm:py-10">

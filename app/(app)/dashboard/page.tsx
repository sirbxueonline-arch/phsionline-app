...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-white to-purple-50 dark:bg-[#070A14]">
      <div className="mx-auto max-w-6xl space-y-5 px-4 py-6">
        <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-[#1F2A44] dark:bg-[#0B1022]">
          <div className="flex items-center gap-3 text-slate-700 dark:text-[#E5E7EB]">
            <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-purple-100 text-purple-700 font-semibold dark:bg-purple-900/50 dark:text-purple-200">
            ...
            <div>
              ...
              <h1 className="text-xl font-semibold text-slate-900 dark:text-[#E5E7EB]">
                Welcome, {profile?.name || user?.email?.split("@")[0] || "Pilot"}
              </h1>
            </div>
          </div>
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-600 dark:border-[#1F2A44] dark:bg-[#0B1022] dark:text-[#E5E7EB]">
        ...
        <div className="grid gap-5 lg:grid-cols-[1.6fr_0.9fr]">
          <div className="space-y-5">
            <div className="rounded-2xl border border-slate-200 bg-gradient-to-r from-white via-purple-50 to-white p-5 shadow-sm dark:border-[#1F2A44] dark:bg-[#0B1022]">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Link href="/library">
                      <Button variant="outline" className="border-slate-200 text-slate-700 hover:bg-slate-50 dark:border-[#1F2A44] dark:text-[#E5E7EB] dark:hover:bg-[#0B1022]">
                        View library
                      </Button>
                    </Link>
                  </div>
                ...
                <div className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700 shadow-sm dark:border-[#1F2A44] dark:bg-[#0B1022] dark:text-[#E5E7EB]">
                  ...
                  <div className="mt-2 h-2 w-40 rounded-full bg-purple-100 dark:bg-purple-900/40">
                    <div className="h-2 rounded-full bg-purple-600" style={{ width: `${usagePct}%` }} />
                  </div>
                  <p className="mt-1 text-xs text-slate-500 dark:text-[#94A3B8]">Resets monthly</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div
                  key={stat.label}
                  className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-[#1F2A44] dark:bg-[#0B1022]"
                >
                  <div
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="border-slate-200 shadow-sm dark:border-[#1F2A44] dark:bg-[#0B1022]">
                ...
                <CardContent className="space-y-3">
                  ...
                  <Link href="/study">
                    <Button
                      variant="outline"
                      className="w-full border-slate-200 text-slate-700 hover:bg-slate-50 dark:border-[#1F2A44] dark:text-[#E5E7EB] dark:hover:bg-[#0B1022]"
                    >
                      Start a study session
                    </Button>
                  </Link>
                  <div className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-xs text-slate-700 dark:border-[#1F2A44] dark:bg-[#0B1022] dark:text-[#E5E7EB]">
                    Save time: pick a preset prompt from the AI suggestions below.
                  </div>
                </CardContent>
              </Card>

              <Card className="shadow-sm border-slate-200 dark:border-[#1F2A44] dark:bg-[#0B1022]">
                <CardHeader>
                  ...
                  <div className="space-y-3">
                    ...
                    {resources.map((res) => (
                      <Link
                        key={res.id}
                        href={`/library/${res.id}`}
                        className="flex items-center justify-between rounded-lg border border-slate-200/70 px-3 py-2 text-sm hover:border-purple-200 hover:bg-purple-50 dark:border-[#1F2A44] dark:hover:bg-[#0B1022]"
                      >
                        <div>
              ...
              <Card className="shadow-sm border-slate-200 dark:border-[#1F2A44] dark:bg-[#0B1022]">
                ...
                <CardContent className="space-y-3">
                  <div className="rounded-lg border border-slate-200/70 bg-slate-50 p-3 dark:border-[#1F2A44] dark:bg-[#0B1022]">
            ...
            <Card className="shadow-sm border-slate-200 dark:border-[#1F2A44] dark:bg-[#0B1022]">
              ...
              <CardContent className="space-y-2">
                {[
                  ...
                  <div
                    key={prompt}
                    className="flex items-center justify-between rounded-lg border border-slate-200 px-3 py-2 text-sm hover:border-purple-200 hover:bg-purple-50 dark:border-[#1F2A44] dark:hover:bg-[#0B1022]"
                  >
